...
namespace E_Commerce_app.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Detials(int orderId)
        {
            OrderVM = new()
            {
                OrderHeader = _unitOfWork.OrderHeader.Get(u => u.Id == orderId, includeProperties: "AppUser"),
                OrderDetial = _unitOfWork.OrderDetial.GetAll(u => u.OrderHeaderId == orderId, includeProperties: "Product")
            };
        ...
        public IActionResult UpdateOrderDetail()
        {
            ...
            return RedirectToAction(nameof(Detials), new { orderId = orderHeaderFromDb.Id });
        }
        ...
        public IActionResult StartProcessing()
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Order Details Updated Successfully.";
            return RedirectToAction(nameof(Detials), new { orderId = OrderVM.OrderHeader.Id });
        }
        ...
        public IActionResult Details_PAY_NOW()
        {
            ...
            OrderVM.OrderDetial = _unitOfWork.OrderDetial
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId)
        {
            ...
            #region API CALLS
            [HttpGet, Route("Admin/Order/GetAll")]
        public IActionResult GetAll(string status)
        {
            ...
            else
            {
                ...
                objOrderHeaders = _unitOfWork.OrderHeader
                    .GetAll(u => u.AppUserId == userId, includeProperties: "AppUser");
            }
